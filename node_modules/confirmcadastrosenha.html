...
<meta name="theme-color" content="#ffffff">
    ...
    <title>Quitanda Online :: Nova Senha Cadastrada</title>
</head>
...
<body>
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            <div class="container">
                <h1>Nova Conta Cadastrada!</h1>
                <hr>
                <p>
                    Caro cliente,
                </p>
                <p>
                    Sua nova conta foi cadastrada com sucesso. Para entrar em sua área restrita agora mesmo, <a href="login.html">clique aqui</a>.
                </p>
                <p>

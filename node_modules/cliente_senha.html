...
<meta name="theme-color" content="#ffffff">
    ...
    <title>Quitanda Online :: Área do Cliente :: Alteração de Senha</title>
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <div class="align-self-end">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a href="cliente_pedidos.html" class="nav-link text-white">Logado como <b>Ricardo Maroquio</b></a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row gx-3">
                    <div class="col-4">
                        <div class="list-group">
                            ...
                            <a href="cliente_senha.html" class="list-group-item list-group-item-action bg-danger text-light">
                    ...
                    <div class="col-8">
                        <form class="col-sm-12 col-md-8 col-lg-6">
                            ...
                            <button type="button" onclick="window.location.href='confirmcadastrosenha.html'"
                                class="btn btn-lg btn-danger">Alterar Senha</button>
                        </form>
                    </div>
                </div>
            </div>
